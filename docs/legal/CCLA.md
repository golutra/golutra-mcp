# golutra-mcp Corporate Contributor License Agreement

本文档是 `golutra-mcp` 的企业贡献授权模板，适用于员工、承包商或其他代表组织提交贡献的场景。
...
1. 我方有权允许上述授权贡献者向 `golutra-mcp` 提交贡献。
2. 上述贡献者在授权范围内提交的贡献，不违反我方对第三方承担的合同、保密义务或知识产权限制。
3. 我方保留自己原本拥有的版权；但对于被 `golutra-mcp` 接收的贡献，我方同意这些代码贡献也按 [`BSD-3-Clause`](./BSD-3-Clause.txt) 入站提交，不附加额外限制。
4. 我方进一步授予 `golutra-mcp` 项目维护者、版权持有人及其被授权方一项全球范围、永久、不可撤销、非独占、可再许可的许可，用于复制、修改、分发、公开展示、公开表演、再许可及以其他方式利用这些贡献。
5. 上述授权明确覆盖：
